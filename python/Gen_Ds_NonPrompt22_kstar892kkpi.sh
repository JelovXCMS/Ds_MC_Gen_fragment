#!/bin/bash
 ...
 pthatArr=(0 0 0.3 2 3.5 9)
 ptnameArr=(pt0 pt1p8 pt3p8 pt5p7ph2 pt9p5ph3p5 pt19ph9)
 is22=(off off on on on on)

 #DataSetNam=Ds_Prompt_phikkpi_pt1p8_cfg.py
 Channel=kstar892kkpi
 PNP=NonPrompt22
 PNParton=5 # not used in MixPNP
...
"""
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(     
            ...
            'PhaseSpace:bias2Selection = ${is22[${idx}]}', # 2 to 2 bias selection asked by George
            'PhaseSpace:bias2SelectionPow = 1.4',
            'PhaseSpace:bias2SelectionRef = ${pthatArr[${idx}]}',
        ),
