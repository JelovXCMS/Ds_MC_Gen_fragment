...
"""
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(     
            'HardQCD:all = on',
            'PhaseSpace:pTHatMin = 0.3', #min pthat
            'PhaseSpace:bias2Selection = on', # 2 to 2 bias selection asked by George
            'PhaseSpace:bias2SelectionPow = 1.4',
            'PhaseSpace:bias2SelectionRef = 0.3',
        ),
...
DsDaufilter = cms.EDFilter("PythiaMomDauFilter",
    ...
    MomMinPt = cms.untracked.double(3.8),
...
Dsrapidityfilter = cms.EDFilter("PythiaFilter",
      ParticleID = cms.untracked.int32(431),
                                  MinPt = cms.untracked.double(3.8),
